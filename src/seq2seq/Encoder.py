...
class Encoder(torch.nn.Module):
	def __init__(self, input_size, hidden_size, n_layers, embedding_matrix=None, embedding_padding_idx=None):
		super(Encoder, self).__init__()
		self.hidden_size = hidden_size
		self.n_layers = n_layers

		self.embedding = torch.nn.Embedding(input_size, hidden_size, padding_idx=embedding_padding_idx)
